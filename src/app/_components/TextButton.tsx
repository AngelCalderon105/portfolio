...
export default function TextButton({text, symbol,textSize, navigation} : { text: string, symbol?: string, textSize: string, navigation?: string}) {
    return (
      <a href={navigation} className={`bg-ui border-2 py-1 px-4 md:py-2 md:px-6 ${textSize} border-text border-opacity-10 rounded-xl inline-flex items-center whitespace-nowrap`}>
